...
%    \centering
%    \begin{subfigure}
%        \includegraphics[width=150mm]{resources/database/stories-records-1}
%    \end{subfigure}
%    \begin{subfigure}
%        \includegraphics[width=150mm]{resources/database/stories-records-2}
%    \end{subfigure}
...
%    \centering
%    \begin{subfigure}
%        \includegraphics[width=150mm]{resources/webapp/digital-ink-home}
%    \end{subfigure}
%    \begin{subfigure}
%        \includegraphics[width=150mm]{resources/webapp/digital-ink-sign-up}
%    \end{subfigure}
...
%    \centering
%    \begin{subfigure}
%        \includegraphics[width=150mm]{resources/webapp/digital-ink-create-story-1}
%    \end{subfigure}
%    \begin{subfigure}
%        \includegraphics[width=150mm]{resources/webapp/digital-ink-create-story-2}
%    \end{subfigure}
%    \begin{subfigure}
...
%    \centering
%    \begin{subfigure}
%        \includegraphics[width=150mm]{resources/webapp/digital-ink-stories}
%    \end{subfigure}
%    \begin{subfigure}
%        \includegraphics[width=150mm]{resources/webapp/digital-ink-story}
%    \end{subfigure}
