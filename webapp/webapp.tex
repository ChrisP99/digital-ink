...
\begin{figure}[!htbp]
    \centering
    \includegraphics[scale=0.5]{resources/database/tables-overview}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[scale=0.5]{resources/database/migrations-records}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[scale=0.5]{resources/database/users-records}
