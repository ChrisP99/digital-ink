...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=125mm]{resources/vpc/step_1_select_a_vpc_configuration}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=125mm]{resources/vpc/step_2_vpc_with_public_and_private_subnets}
...
After entering the internet gateway name and clicking the "Create internet gateway" button, the newly created
...
route table.
From the "Route tables" page, \mintinline{zsh}|Public route| is selected, and the "Edit subnet associations" button is
clicked.
...
On this page, click the "Add route" button and enter a destination of \mintinline{zsh}|0.0.0.0/0| and, for the target,
