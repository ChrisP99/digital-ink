...
%    \centering
%    \begin{subfigure}
%        \includegraphics[width=150mm]{resources/vpc/step_3_create_vpc}
%    \end{subfigure}
%    \begin{subfigure}
...
%    \centering
%    \begin{subfigure}
%        \includegraphics[width=150mm]{resources/vpc/routes/vpc-public-route}
%    \end{subfigure}
%    \begin{subfigure}
...
%    \centering
%    \begin{subfigure}
%        \includegraphics[width=150mm]{resources/vpc/routes/vpc-subnet-public-ass}
%    \end{subfigure}
%    \begin{subfigure}
