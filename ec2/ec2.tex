...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=125mm]{resources/ec2/create-instance-application-and-os-images}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=125mm]{resources/ec2/create-instance-instance-type}
